...
MCP (Model Context Protocol) server providing accessibility analysis tools for WCAG 2.1 compliance.

## Overview

This MCP server provides programmatic tools for color contrast analysis according to WCAG 2.1 standards. It's designed to be used by the AccessLint plugin's reviewer and refactor agents to perform automated accessibility checks.
...
Analyze a color pair for WCAG compliance with detailed pass/fail information.
